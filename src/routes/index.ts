...
router.use('/api/v1/plans', planRoutes); // Plan routes under /api/v1/plans
...
// Note: Webhook routes are handled separately in index.ts before JSON parsing middleware
